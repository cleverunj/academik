...
function Login(props) {
  ...
  const aceptar = (e) => {
    ...
    if(errors === true){
      ...
      Axios.post('http://localhost/api-admision/login/validacion', data)
        .then((res) => {
  ...
  return (
    ...
    <div className="row">
      <div className="col-sm-10 col-md-9 col-lg-5 mx-auto">
        <Card className="border-0 shadow  p-3 rounded-3 my-5 ">
        <Card.Title className="text-center mt-5 fw-light fs-5"><img src={logo} alt="logo" /></Card.Title>
        <Card.Body className="p-4 p-sm-5">
        <Card.Title className="text-center mt-3 fw-light ">Inicio de sesión</Card.Title>
